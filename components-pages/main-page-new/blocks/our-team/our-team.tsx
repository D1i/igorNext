                ...
                <div className={s.personList}>
                    <div className={s.person}>
                        <div className={s.leftBlock}>
                            <Image placeholder="blur" className={s.avatar}
                                   src={require('./img/avatars/mariaAvatar.png')}
                        ...
                        <div className={s.rightBlock}>
                            ...
                            <div className={s.diplomas}>
                                <Image placeholder="blur" src={require('./img/documents/img.png')} alt=""/>
                                <Image placeholder="blur" src={require('./img/documents/img_1.png')} alt=""/>
                                <Image placeholder="blur" src={require('./img/documents/img_2.png')} alt=""/>
                                <Image placeholder="blur" src={require('./img/documents/img_12.png')} alt=""/>
                                <Image placeholder="blur" src={require('./img/documents/img_3.png')} alt=""/>
                                <Image placeholder="blur" src={require('./img/documents/img_4.png')} alt=""/>
                                <Image placeholder="blur" src={require('./img/documents/img_5.png')} alt=""/>
                            </div>
                        </div>
                    </div>
                    <div className={s.person}>
                        <div className={s.leftBlock}>
                            <Image className={s.avatar} src={require('./img/avatars/mariaAvatar.png')}
                        ...
                        <div className={s.rightBlock}>
                            ...
                            />
                            <div className={s.diplomas}>
                                <Image placeholder="blur" src={require('./img/documents/img_6.png')} alt=""/>
                                <Image placeholder="blur" src={require('./img/documents/img_7.png')} alt=""/>
                                <Image placeholder="blur" src={require('./img/documents/img_8.png')} alt=""/>
                                <Image placeholder="blur" src={require('./img/documents/img_9.png')} alt=""/>
                                <Image placeholder="blur" src={require('./img/documents/img_10.png')} alt=""/>
                                <Image placeholder="blur" src={require('./img/documents/img_11.png')} alt=""/>
                            </div>
                        </div>
                    </div>
                </div>
